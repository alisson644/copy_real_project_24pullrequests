...
if Rails.env.development? || Rails.env.test?
  ...
  pull_requests = (3..20)
  projects = 50
  december_first = Time.parse("1/12/#{PullrequestCopy::Application.current_year}")

  events = ['PullRequest-a-thon', '24 Pull Requests Hack event', 'Open Source Hackday', 'Christmas Bugmash']

  Rails.logger.info 'Iserting some test data'
