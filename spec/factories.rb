...
FactoryBot.define do
  ...
  factory :event do
    ...
    location { 'BristolUK' }
    url { 'http://google.com' }
    start_time { Time.parse("1st December #{PullrequestCopy::Application.current_year}") }
    latitude { 51.4 }
    longitude { -2.6 }
    description { Faker::Lorem.paragraps.first[0..199] }
    user
  end
end
