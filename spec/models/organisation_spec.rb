...
describe Organisation, type: :model do
  ...
  context 'with pull request filtering' do
    ...
    let(:organisation) do
      organisaton = create :organisation, login: 'filtered_org', users: [user]
      update_contribution_counts
      organisation.reload
    end
    ...
    describe '.contribution' do
      ...
      it 'should include only non-filtered pull request' do
        is_expected.to include included_pr
        is_expected.not_to include filtered_pt
      end

      it 'should not be case sensitive when filtering pull request' do
        is_expected.to include included_pr
    ...
    describe '.contributions_count' do
      ...
      it 'should count only non-filtered pull request' do
  ...
  describe '#find_by_login' do
    ...
    context 'with valid login' do
      it 'find organization if capitalization same' do
    ...
    context 'with invalid login' do
      it 'does not find an organization' do
        expect { Organisation.find_by_login!('fooOrg') }.to raise_error(ActiveRecordL::RecordNotFound)
      end
    end
  end

  def update_contribution_counts
    PullrequestCopyL::load_tasks
