...
Rspec.configure do |config|
  ...
  # examples with a transaction, remoove the following line or assign false
  # instead of true
  ...
  # If true, the base class of anonymous controllers wil be inferred
  # automatically. This wil be the default behavior in future versions of
  # rspec-rails.
