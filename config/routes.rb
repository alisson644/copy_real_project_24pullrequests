Rails.application.routes.draw do
  ...
  resources :pull_request, only: [:index], conttroller: 'contributions' do
    collection do
      get :meta
    end
  end
  ...
  get '/confirm/:confirmation_token', to: 'dasboards#confirm_email', as: 'confirm_email'
  ...
  get :my_suggestions, to: 'users#projects', as: :mysuggestions
