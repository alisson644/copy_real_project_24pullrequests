module ApplicationHelper
  ...
  def github_button(nickname)
    %(<iframe src="http://ghbs.com/github-btn-btn.html?user=#{nickname}&type=follow&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="300" height="20"></iframe>).html_safe
  end
